...
### Cepstrograms
Left top graph is cepstrograms breakdown of the lofi beat by less.people from research playlist#1.

Left bottom graph is cepstrograms breakdown of the soft classic song by Chopin from research playlist#2.

Right chart is cepstrograms breakdown of the pop song "Pink Venom" by Blackpink from research playlist#3.
```{r}
lofi <-
...
chopin |>
  ...
  ggplot(
    aes(
      ...
      width = duration,
      y = basis,
      fill = value, title(main = "Nocturn by Chopin")
    )
  ) +
  geom_tile() +
  labs(x = "Time (s)", y = NULL, fill = "Magnitude") +
